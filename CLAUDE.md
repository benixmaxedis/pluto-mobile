...
- NativeWind + Tailwind for styling, theme tokens in src/lib/theme/ (General Sans UI + Michroma for Now date/times; fonts in assets/fonts + @expo-google-fonts/michroma)
